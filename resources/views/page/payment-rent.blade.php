...
<main class="pt-24 pb-20 bg-white min-h-screen">
    ...
    <div class="text-center mb-8 px-4">
        ...
        <p class="text-gray-500">Complete your rental payment</p>
    </div>
    ...
    <div class="max-w-2xl mx-auto px-4">
        <div class="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-xl">
            ...
            <form action="{{ route('rent.submit_payment', $rent->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="bg-bedengan-surface rounded-xl p-6 mb-8 border border-bedengan-primary/20">
                    ...
                    <div id="content-qris" class="hidden text-center">
                        ...
                        <div class="bg-white p-4 rounded-lg inline-block shadow-sm mb-4">
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=BayarSewa{{$rent->id}}" alt="QRIS Code" class="w-40 h-40">
                        </div>
                ...
                <div class="flex gap-4">
                    <a href="{{ route('rent.index') }}" class="flex-1 py-3 rounded-xl border border-gray-300 text-gray-600 font-semibold text-center hover:bg-gray-50 transition flex items-center justify-center">
                        Back
                    </a>
